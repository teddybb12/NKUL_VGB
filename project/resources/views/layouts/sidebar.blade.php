...
<div class="sidebar" style="background: #f0d39c;">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="#" class="d-block" style="font-weight:bold">{{ Auth::User()->nom }}
                {{ Auth::User()->prenom }}</a>
        </div>
    </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('gestion_enquete.create') }}" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('gestion_users.create') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Ajouter utilisateur</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('gestion_users.index') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
