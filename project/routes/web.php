...
use App\Http\Controllers\RespCommentController;
...
Route::resource('gestion_des_alerts', AlertController::class);
Route::get('destroyAlert/{id}', [AlertController::class, 'destroy']);

Route::resource('gestion_des_posts', PostController::class);
Route::get('destroyPost/{id}', [PostController::class, 'destroy']);

Route::resource('gestion_des_comment', CommentController::class);
Route::get('destroyComment/{id}', [CommentController::class, 'destroy']);

Route::resource('gestion_des_reponses', RespCommentController::class);
Route::get('destroyRespComment/{id}', [RespCommentController::class, 'destroy']);
