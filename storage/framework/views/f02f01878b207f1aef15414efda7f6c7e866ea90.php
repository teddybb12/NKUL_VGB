    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-light-dark elevation-4">
            ...
            <div class="sidebar-custom">
                <a href="<?php echo e(route('home')); ?>" class="btn btn-link"><i class="fas fa-cogs text-dark"></i></a>
                <a href="<?php echo e(route('home')); ?>" class="btn btn-dark hide-on-collapse pos-right">Dashboard</a>
            </div>
            <!-- /.sidebar-custom -->
        </aside>
...
<?php /**PATH /Users/kamgafrank/Documents/projects/NKUL_VGB/resources/views/layouts/mainlayout.blade.php ENDPATH**/ ?>