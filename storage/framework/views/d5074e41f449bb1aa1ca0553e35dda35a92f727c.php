        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                ...
                <div class="small-box bg-dark" style="border-left: 3px solid black;">
                    ...
                    <div class="inner">
                        <h3><?php echo e($cameroun->count()); ?></h3>
                        <h3>Cameroun</h3>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="small-box bg-warning" style="border-left: 3px solid black;">
                    ...
                    <div class="inner">
                        <h3><?php echo e($centraf->count()); ?></h3>
                        <h3>Centrafrique</h3>
                    </div>
                    <div class="icon">
...
<?php echo $__env->make('layouts.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/kamgafrank/Documents/projects/NKUL_VGB/resources/views/home.blade.php ENDPATH**/ ?>