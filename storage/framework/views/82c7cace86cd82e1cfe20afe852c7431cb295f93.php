        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="<?php echo e(route('form_enquette')); ?>" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Ajouter Enquetes</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('list_enquette')); ?>" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('profile_user')); ?>" class="nav-link">
...
<!-- /.sidebar -->
<?php /**PATH /Users/kamgafrank/Documents/projects/NKUL_VGB/resources/views/layouts/sidebar2.blade.php ENDPATH**/ ?>