<?php $__env->startSection('maincontent'); ?>
    <!-- SELECT2 EXAMPLE -->
    <form action="<?php echo e(route('gestion_enquete.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card shadow">
            <div class="card-body">
                <div class="row">
                    <input name="user_id" type="text" value="<?php echo e(Auth::User()->id); ?>" hidden>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Orientation sexuel</label>
                            <select name="orientation_sexuel" class="form-control select1" style="width: 100%;">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="auteur_violence" class="form-control select1" style="width: 100%;">
...
<?php echo $__env->make('layouts.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/kamgafrank/Documents/projects/NKUL_VGB/resources/views/enquettes/form.blade.php ENDPATH**/ ?>